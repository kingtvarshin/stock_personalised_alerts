...
# indicators_df = pd.read_csv(f'./stock_indicators_csv/indicators_data.csv')

indicators_df = pd.DataFrame(indicators_data)
indicators_df['cap'] = pd.Categorical(indicators_df['cap'],categories = ["large_cap","mid_cap","small_cap"])
indicators_df.sort_values(by="cap")
print(indicators_df[indicators_df['cap']=='large_cap'])
print(indicators_df[indicators_df['cap']=='mid_cap'])
print(indicators_df[indicators_df['cap']=='small_cap'])
